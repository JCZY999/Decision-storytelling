...
The [Python Data Visualization Techniques](python_visualization/README.md) module turns the storytelling principles above into executable examples. It includes a deterministic marketing dataset, reusable Matplotlib functions, eight generated chart types, and automated tests.
...
![Decision-focused ranked comparison](python_visualization/outputs/01_ranked_comparison.png)
